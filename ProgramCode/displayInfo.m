...
set(h5,'XData',xVector,'YData',yVector);
axis([minX maxX minY maxY]);


% subplot(1,2,1)
% set(h6,'XData',x3,{'YData'},{boomK;stickK;bucketK;slewK});
% axis([0 500 -150 150]);

subplot(1,2,2)
set(h7,'XData',x3,{'YData'},{setPointBC1;setPointDE1;curPointBC1;curPointDE1});
axis([0 500 2 3.5]);
clc;
drawnow;
